// Generated from E:/develop/project/es-sql/src/main/antlr4/com.cjq.sql.catalyst.parser/SqlBaseLexer.g4 by ANTLR 4.13.1
...
public class SqlBaseLexer extends Lexer {
	...
	public static final int
		...
		MATCH_PHRASE=350, TERM=351, MULTI_MATCH=352, FUZZY=353, MISSING_QUERY=354, 
		EQ=355, NSEQ=356, NEQ=357, NEQJ=358, LT=359, LTE=360, GT=361, GTE=362, 
		PLUS=363, MINUS=364, ASTERISK=365, SLASH=366, PERCENT=367, TILDE=368, 
		AMPERSAND=369, PIPE=370, CONCAT_PIPE=371, HAT=372, COLON=373, DOUBLE_COLON=374, 
		ARROW=375, FAT_ARROW=376, HENT_START=377, HENT_END=378, QUESTION=379, 
		STRING_LITERAL=380, DOUBLEQUOTED_STRING=381, BIGINT_LITERAL=382, SMALLINT_LITERAL=383, 
		TINYINT_LITERAL=384, INTEGER_VALUE=385, SINGLE_DIGIT=386, EXPONENT_VALUE=387, 
		DECIMAL_VALUE=388, FLOAT_LITERAL=389, DOUBLE_LITERAL=390, BIGDECIMAL_LITERAL=391, 
		IDENTIFIER=392, BACKQUOTED_IDENTIFIER=393, SIMPLE_COMMENT=394, BRACKETED_COMMENT=395, 
		WS=396, UNRECOGNIZED=397;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MATCH_PHRASE", "TERM", "MULTI_MATCH", "FUZZY", "MISSING_QUERY", "EQ", 
			"NSEQ", "NEQ", "NEQJ", "LT", "LTE", "GT", "GTE", "PLUS", "MINUS", "ASTERISK", 
			"SLASH", "PERCENT", "TILDE", "AMPERSAND", "PIPE", "CONCAT_PIPE", "HAT", 
			"COLON", "DOUBLE_COLON", "ARROW", "FAT_ARROW", "HENT_START", "HENT_END", 
			"QUESTION", "STRING_LITERAL", "DOUBLEQUOTED_STRING", "BIGINT_LITERAL", 
			"SMALLINT_LITERAL", "TINYINT_LITERAL", "INTEGER_VALUE", "SINGLE_DIGIT", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'TERM'", "'MULTI_MATCH'", "'FUZZY'", "'MISSING_QUERY'", null, "'<=>'", 
			"'<>'", "'!='", "'<'", null, "'>'", null, "'+'", "'-'", "'*'", "'/'", 
			"'%'", "'~'", "'&'", "'|'", "'||'", "'^'", "':'", "'::'", "'->'", "'=>'", 
			"'/*+'", "'*/'", "'?'"
		};
