...
public class SqlBaseParserBaseListener implements SqlBaseParserListener {
     ...
     */
    @Override
    public void enterSetCollation(SqlBaseParser.SetCollationContext ctx) {
    }
     ...
     */
    @Override
    public void exitSetCollation(SqlBaseParser.SetCollationContext ctx) {
    }
     ...
     */
    @Override
    public void enterFuzzinessExpression(SqlBaseParser.FuzzinessExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void exitFuzzinessExpression(SqlBaseParser.FuzzinessExpressionContext ctx) {
    }
